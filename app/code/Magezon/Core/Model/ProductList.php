...
class ProductList
{
     ...
     * @return void
     */
    public function addIsInStockFilterToCollection($collection, $isShowOutOfStock)
    {
    ...
    public function getProductCollection($source = 'latest', $numberItems = 8, $order = 'newestfirst', $conditions = '', $showOutOfStock = false)
    {
        ...
        if ($showOutOfStock) {
            $stockFlag = 'has_stock_status_filter';
            $collection->setFlag($stockFlag, true);
            $this->addIsInStockFilterToCollection($collection, true);
        }
